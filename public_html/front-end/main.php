...
<body>
    ...
    <div class="container" style="margin-top:3%;">
        <?php
            ...
            //getting comments|day for each UserID
            $sql = "SELECT COUNT(*) AS numComments FROM SHARES GROUP BY $UserID, Date";
        ...
        <div class="boxshadow" style="padding-bottom: 3%; box-shadow:4px 3px 5px 3px #888888;">
            <div id="chartContainer" style="height: 300px; width: 100%; margin-top:3%; padding-top:3%;"></div>
        </div>
